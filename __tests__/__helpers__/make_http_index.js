...
var fsListing = JSON.stringify(rdSync(path.join(__dirname, '..', '__fixtures__'), {}, '/'));
fs.writeFileSync(path.join(__dirname, '..', '__fixtures__', 'index.json'), fsListing, { encoding: 'utf8' });
