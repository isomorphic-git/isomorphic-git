...
const messages = {
  ...
  InvalidParameterTypeError: `The function "{ function }" expected "{ expected }" type as the parameter "{ parameter }", but given "{ type }" type.`,
...
export const E = {
  ...
  InvalidParameterTypeError: `InvalidParameterTypeError`,
