...
module.exports = {
  scripts: {
    ...
    test: {
      ...
      jest: process.env.CI
        ? retry3(`${timeout5('node --experimental-vm-modules node_modules/jest/bin/jest.js --ci --coverage')}`)
        : `node --experimental-vm-modules node_modules/jest/bin/jest.js --ci --coverage`,
