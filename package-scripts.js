...
module.exports = {
  scripts: {
    ...
    build: {
      ...
      rollup: 'rollup -c',
      umd:
        'browserify --entry dist/for-browserify/index.js --standalone git --debug --exclude fliplog | uglifyjs --compress --mangle --source-map "content=inline" -o dist/bundle.umd.min.js'
    },
    test: {
